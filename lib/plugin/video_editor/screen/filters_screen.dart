...
import 'package:divine/plugin/video_editor/src/widget/cover/cover_viewer.dart';
import 'package:divine/plugin/video_editor/src/utility/controller.dart';

import '../src/widget/crop/crop_grid.dart';
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              if (mounted) {
                widget.controller
                    .setFilterOpacity(widget.controller.filterOpacity);
