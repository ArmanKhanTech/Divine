...
import '../../page/gallery_media_picker_controller.dart';
              ...
              if (data.hasData) {
                return Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image(
                        image: DecodeImage(
                            widget.provider.pathList[widget.provider.pathList
                                .indexOf(widget.provider.currentAlbum!)],
                            index: widget.index),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 1.5,
                            color:
                                widget.provider.paramsModel.selectedCheckColor),
                      ),
                      child: Icon(
                        Icons.check,
