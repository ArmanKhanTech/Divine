...
import 'package:divine/module/profile/screen/profile_picture_screen.dart';

import '../../../component/text_form_builder.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Form buildForm(EditProfileViewModel viewModel, BuildContext context) {
      return Form(
