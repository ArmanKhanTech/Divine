...
class ConfirmSinglePostScreen extends StatefulWidget {
  ...
  const ConfirmSinglePostScreen({Key? key, required this.postImages})
      : super(key: key);

  @override
  State<ConfirmSinglePostScreen> createState() =>
      _ConfirmSinglePostScreenState();
}

class _ConfirmSinglePostScreenState extends State<ConfirmSinglePostScreen>
    with TickerProviderStateMixin {
  Future<dynamic> exitDialog({required PostsViewModel viewModel}) {
    return showDialog(
        context: context,
          ...
          body: ListView(
            children: [
              ...
              SizedBox(
                ...
                child: widget.postImages.length > 1
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                              ...
                              decoration: BoxDecoration(
                                image: viewModel.mediaUrl!.isNotEmpty
                                    ? DecorationImage(
                                        image: NetworkImage(
                                            viewModel.mediaUrl![index]),
                                        fit: BoxFit.cover)
                                    : DecorationImage(
                                        image:
                                            FileImage(widget.postImages[index]),
                                        fit: BoxFit.cover,
                                      ),
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      labelStyle: TextStyle(
                          color: Colors.blue, fontSize: 18.0, height: 1.2),
                      hintText: 'Eg. This is very beautiful place!',
                      hintStyle: TextStyle(
                          color: Colors.white70, fontSize: 18.0, height: 1.2),
                      enabled: true,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      padding:
                          const EdgeInsets.only(bottom: 8.0, left: 8, top: 5),
                      child: Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          viewModel.mentions.isEmpty
                              ? 'Add all the people you want to mention in this post here.'
