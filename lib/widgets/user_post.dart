...
class _UserPostState extends State<UserPost> {
                                      ...
                                      return Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ListView.builder(
                                              shrinkWrap: true,
                                              itemCount: widget.post!.mentions!.length,
                                              itemBuilder: (context, index) {
                                                return ListTile(
                                                  onTap: () {
                                                    ...
                                                    builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                                                      if (snapshot.hasData) {
                                                        if(snapshot.data!.exists) {
                                                          ...
                                                          return user.photoUrl!.isEmpty ? CircleAvatar(
                                                            radius: 20,
                                                            backgroundColor:
                                                          ...
                                                          return CircleAvatar(
                                                            ...
                                                            child: Center(
                                                              child: Text(
                                                                widget.post!.mentions![index][0].toUpperCase(),
                                                                style: const TextStyle(
                                                                  color: Colors.blue,
                                                                  fontSize: 15.0,
                                                                  fontWeight: FontWeight.bold,
  ...
  buildLikeButton() {
    return StreamBuilder(
      stream: likesRef.where('postId', isEqualTo: widget.post!.postId)
          ...
          Future<bool> onLikeButtonTapped(bool isLiked) async {
            if (docs.isEmpty) {
              ...
              services.removeLikeFromNotification(
                  widget.post!.ownerId!, widget.post!.postId!, currentUserId(), widget.post!.hashtags!);
              return isLiked;
            }
          }
          return LikeButton(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          widget.post!.location != null &&
                              widget.post!.location.toString().isNotEmpty ? Text(
