import 'package:divine/viewmodels/screens/posts_view_model.dart';
...
class _ProfilePictureScreenState extends State<ProfilePictureScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<dynamic> showImageChoices(
        BuildContext context, PostsViewModel viewModel) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      dense: true,
                      contentPadding:
                          const EdgeInsets.only(left: 25, bottom: 8, top: 10),
                      visualDensity:
      ...
      builder: (context) {
        return PopScope(
          ...
          child: LoadingOverlay(
            progressIndicator:
                circularProgress(context, const Color(0XFF03A9F4)),
            opacity: 0.5,
            color: Theme.of(context).colorScheme.surface,
                  ...
                  InkWell(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: viewModel.media == null
                              ? Center(
                                  child: Text(
                                    kIsWeb != true
                                        ? 'Tap to select your profile picture'
                                        : 'Click to select your profile picture',
                                    style: TextStyle(
