...
import 'package:divine/modules/post/screens/pick_from_gallery_screen_posts.dart';
import 'package:divine/modules/post/screens/preview_image.dart';
...
class _NewPostScreenState extends State<NewPostScreen>
  ...
  Future<void> initCamera() async {
    ...
    controller = CameraController(
        widget.title != 'Profile Picture' ? cameras.first : cameras.last,
    ...
    return Scaffold(
        ...
        body: isCameraInitialized == true &&
            ...
            : Padding(
                ...
                child: Center(
                    child:
                        circularProgress(context, const Color(0xFF9C27B0)))));
  }
                ...
                switch (widget.title) {
                  ...
                  case 'New Post':
                    Navigator.push(
                            context,
                            CupertinoPageRoute(
                                builder: (_) => PreviewImage(imageFile: file)))
                        .then((value) {
                      setState(() {
                        pictureTaken = false;
                      });
          ...
          IconButton(
            onPressed: () {
              ...
              Navigator.push(
                  context,
                  CupertinoPageRoute(
                      builder: (_) => const PickFromGalleryScreenPosts()));
            },
            icon: const Icon(
  ...
  dynamic showSnackBar({required String msg}) {
    showTopSnackBar(
      Overlay.of(context),
